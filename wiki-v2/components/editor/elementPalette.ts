...
export const ELEMENT_PALETTE: ElementPaletteItem[] = [
  ...
  { key: 'blockquote',  label: 'Zitat',             icon: '"',   group: 'Basic', keywords: 'quote zitat' },
  { key: 'callout',     label: 'Callout',           icon: '💡',  group: 'Basic', keywords: 'callout hinweis info warnung tipp box notiz achtung wichtig' },
